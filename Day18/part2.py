...
class SnailfishNumber:
    ...
    def __add__(self, other):
        return SnailfishNumber(copy(self), copy(other))
...
for subset in itertools.combinations(numbers, 2):
    ...
    a = first + second
    a.reduce()
    # print("{} + {} = {} has magnitude {}".format(first, second, a, a.magnitude()))
    b = second + first
    b.reduce()
    # print("{} + {} = {} has magnitude {}".format(second, first, b, b.magnitude()))
    max_magnitude = max(max_magnitude, a.magnitude(), b.magnitude())
